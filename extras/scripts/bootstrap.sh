...
apt-get update
apt-get -y install curl software-properties-common dirmngr
...
apt-get install -y build-essential python3-dev mariadb-server libssl-dev libffi-dev git nodejs libcurl4-openssl-dev libsasl2-dev libldap2-dev
apt-get remove -y python3-httplib2 python3-pycurl
